...
Examples:
  ...
  MKM GET orders/2/8 > received.txt
        ...
        {
            public static string appToken = "6p6PvROtWiXrXofs";
            public static string appSecret = "pSccPMwGyJac23u5USMiIK93pJSRIgYM";
            public static string accessToken = "kydXaeNqXmKpJdVABuCIYpqpP4iJixVD";
            public static string accessSecret = "hj5UCdoZaxFm7YhaDR20LQFiCUjyTvbK";
            public static string url = "http://www.awesomemkm3rdpartyapp.eu/callback.php?request_token=";
